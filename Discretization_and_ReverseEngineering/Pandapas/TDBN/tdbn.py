...
group1 = np.array(range(0,13))

# change the path of input dataset!
# current input data sets are from q2 discretization

def dataSwitch(filenum, group1):
	filename = "q2/y"+str(filenum)+".txt"
	data = np.loadtxt(filename, skiprows = 0)
	for t in range(0,6):
		for node in range(0,13):
