...
Part 2: indirectly look at the trend of the data by looking at the number of local maximum and local minimum; either local maximum or local minimum signals the change of the moving direction in the time series, thus serves an indicator for the trend; this part of the code consists of DerivativeTrend.m, TrendConfusionMatrix.m, TrendChange.m; 
